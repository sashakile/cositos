...
- [x] 8.4 Update the `protocol` spec in `openspec/specs/protocol/spec.md` to include the cycle-detection and depth-cap requirements from the delta spec (sync after archive)
